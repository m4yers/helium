...
void MIPS_Init()
{
    ...
    M_regs_all = M_Regs (NULL, NULL);
    M_RegsAdd (M_regs_all, zero, "zero");

    M_RegsAdd (M_regs_all, at, "at");

    M_RegsAdd (M_regs_all, v0, "v0");
    M_RegsAdd (M_regs_all, v1, "v1");

    M_RegsAdd (M_regs_all, a0, "a0");
    M_RegsAdd (M_regs_all, a1, "a1");
    M_RegsAdd (M_regs_all, a2, "a2");
    M_RegsAdd (M_regs_all, a3, "a3");

    M_RegsAdd (M_regs_all, t0, "t0");
    M_RegsAdd (M_regs_all, t1, "t1");
    M_RegsAdd (M_regs_all, t2, "t2");
    M_RegsAdd (M_regs_all, t3, "t3");
    M_RegsAdd (M_regs_all, t4, "t4");
    M_RegsAdd (M_regs_all, t5, "t5");
    M_RegsAdd (M_regs_all, t6, "t6");
    M_RegsAdd (M_regs_all, t7, "t7");
    M_RegsAdd (M_regs_all, t8, "t8");
    M_RegsAdd (M_regs_all, t9, "t9");

    M_RegsAdd (M_regs_all, s0, "s0");
    M_RegsAdd (M_regs_all, s1, "s1");
    M_RegsAdd (M_regs_all, s2, "s2");
    M_RegsAdd (M_regs_all, s3, "s3");
    M_RegsAdd (M_regs_all, s4, "s4");
    M_RegsAdd (M_regs_all, s5, "s5");
    M_RegsAdd (M_regs_all, s6, "s6");
    M_RegsAdd (M_regs_all, s7, "s7");

    M_RegsAdd (M_regs_all, k0, "k0");
    M_RegsAdd (M_regs_all, k1, "k1");

    M_RegsAdd (M_regs_all, gp, "gp");

    M_RegsAdd (M_regs_all, sp, "sp");
    M_RegsAdd (M_regs_all, fp, "fp");
    M_RegsAdd (M_regs_all, ra, "ra");

    M_regs_colors = M_Regs (NULL, NULL);

    M_RegsAdd (M_regs_colors, v0, "v0");
    /* M_RegsAdd (M_regs_colors, v1, "$v1"); */

    M_RegsAdd (M_regs_colors, a0, "a0");
    M_RegsAdd (M_regs_colors, a1, "a1");
    M_RegsAdd (M_regs_colors, a2, "a2");
    M_RegsAdd (M_regs_colors, a3, "a3");

    M_RegsAdd (M_regs_colors, t0, "t0");
    M_RegsAdd (M_regs_colors, t1, "t1");
    M_RegsAdd (M_regs_colors, t2, "t2");
    M_RegsAdd (M_regs_colors, t3, "t3");
    M_RegsAdd (M_regs_colors, t4, "t4");
    M_RegsAdd (M_regs_colors, t5, "t5");
    M_RegsAdd (M_regs_colors, t6, "t6");
    M_RegsAdd (M_regs_colors, t7, "t7");
    M_RegsAdd (M_regs_colors, t8, "t8");
    M_RegsAdd (M_regs_colors, t9, "t9");

    M_RegsAdd (M_regs_colors, s0, "s0");
    M_RegsAdd (M_regs_colors, s1, "s1");
    M_RegsAdd (M_regs_colors, s2, "s2");
    M_RegsAdd (M_regs_colors, s3, "s3");
    M_RegsAdd (M_regs_colors, s4, "s4");
    M_RegsAdd (M_regs_colors, s5, "s5");
    M_RegsAdd (M_regs_colors, s6, "s6");
    M_RegsAdd (M_regs_colors, s7, "s7");

    /* M_RegsAdd (M_regs_colors, sp, "sp"); */
    /* M_RegsAdd (M_regs_colors, fp, "fp"); */
    M_RegsAdd (M_regs_colors, ra, "ra");

    M_regs_result = M_Regs (NULL, NULL);
    M_RegsAdd (M_regs_result, v0, "v0");
    M_RegsAdd (M_regs_result, v1, "v1");

    M_regs_special = M_Regs (NULL, NULL);
    M_RegsAdd (M_regs_special, zero, "zero");
    M_RegsAdd (M_regs_special, sp,   "sp");
    M_RegsAdd (M_regs_special, fp,   "fp");
    M_RegsAdd (M_regs_special, ra,   "ra");
    /* M_RegsAdd (M_regs_special, v0,   "v0"); */
    /* M_RegsAdd (M_regs_special, v1,   "v1"); */

    M_regs_arguments = M_Regs (NULL, NULL);
    M_RegsAdd (M_regs_arguments, a0, "a0");
    M_RegsAdd (M_regs_arguments, a1, "a1");
    M_RegsAdd (M_regs_arguments, a2, "a2");
    M_RegsAdd (M_regs_arguments, a3, "a3");

    M_regs_caller_save = M_Regs (NULL, NULL);
    M_RegsAdd (M_regs_caller_save, t0, "t0");
    M_RegsAdd (M_regs_caller_save, t1, "t1");
    M_RegsAdd (M_regs_caller_save, t2, "t2");
    M_RegsAdd (M_regs_caller_save, t3, "t3");
    M_RegsAdd (M_regs_caller_save, t4, "t4");
    M_RegsAdd (M_regs_caller_save, t5, "t5");
    M_RegsAdd (M_regs_caller_save, t6, "t6");
    M_RegsAdd (M_regs_caller_save, t7, "t7");
    M_RegsAdd (M_regs_caller_save, t8, "t8");
    M_RegsAdd (M_regs_caller_save, t9, "t9");

    M_regs_callee_save = M_Regs (NULL, NULL);
    // fp is always used by the callee
    M_RegsAdd (M_regs_callee_save, fp, "fp");
    M_RegsAdd (M_regs_callee_save, s7, "s7");
    M_RegsAdd (M_regs_callee_save, s6, "s6");
    M_RegsAdd (M_regs_callee_save, s5, "s5");
    M_RegsAdd (M_regs_callee_save, s4, "s4");
    M_RegsAdd (M_regs_callee_save, s3, "s3");
    M_RegsAdd (M_regs_callee_save, s2, "s2");
    M_RegsAdd (M_regs_callee_save, s1, "s1");
    M_RegsAdd (M_regs_callee_save, s0, "s0");

    regs_map = M_RegsToTempMap (Temp_Empty(), M_regs_all);
}
